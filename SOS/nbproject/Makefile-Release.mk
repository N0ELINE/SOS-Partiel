...
${OBJECTDIR}/arbreRougeNoir.o: arbreRougeNoir.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arbreRougeNoir.o arbreRougeNoir.c

${OBJECTDIR}/avlTree.o: avlTree.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/avlTree.o avlTree.c

${OBJECTDIR}/binaryHeap.o: binaryHeap.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/binaryHeap.o binaryHeap.c

${OBJECTDIR}/binarySearchTree.o: binarySearchTree.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/binarySearchTree.o binarySearchTree.c
...
${OBJECTDIR}/stackUsingPointers.o: stackUsingPointers.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stackUsingPointers.o stackUsingPointers.c
